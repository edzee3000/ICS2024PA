...
//INSTPAT(模式字符串, 指令名称, 指令类型, 指令执行操作);
  ...
  INSTPAT("0000001 ????? ????? 001 ????? 01100 11", mulh  ,R,{long long int src3=src1;src3<<=32;src3>>=32;long long int src4=src2; src4<<=32;src4>>=32;printf("src:%#llx\n",src3*src4); R(rd)=(int32_t)(((int64_t)src1*(int64_t)src2)>>32);});//############可能会出问题##############
